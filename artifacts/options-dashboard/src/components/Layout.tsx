...
import { LayoutDashboard, TrendingUp, Settings2, BarChart2, Plus } from "lucide-react";
      ...
      <aside className="w-56 flex-shrink-0 flex flex-col bg-sidebar border-r border-sidebar-border">
        ...
        <div className="px-2 py-3 border-t border-sidebar-border">
          <Link href="/trades/new">
            {(props: React.AnchorHTMLAttributes<HTMLAnchorElement>) => (
              <a {...props} className="flex items-center gap-2 w-full px-3 py-2 text-sm rounded bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">
                <Plus size={14} />
                New Trade
              </a>
            )}
        ...
        <div className="px-4 py-3 border-t border-sidebar-border">
          <div className="text-xs text-muted-foreground">NSE Market Hours</div>
